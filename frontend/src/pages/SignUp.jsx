...
export default function SignUp() {
  ...
  return (
    <div className="min-h-screen signup-hero signup-hero--clean cinema-mood">
      <div className="auth" style={{ paddingTop: '64px', paddingBottom: '64px' }}>
        <div className="auth__panel" style={{ width: 'min(680px, 92%)' }}>
          <h2 className="auth__title">Đăng ký</h2>
          <p className="auth__subtitle">Nhận ưu đãi và quyền lợi độc quyền từ MovieClub</p>
